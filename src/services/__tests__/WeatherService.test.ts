import nock from 'nock' // Permet de simuler un serveur et ses réponses API
...
describe('WeatherService', () => {
  ...
  // Doit renvoyer CurrentWeather formaté depuis l'API
  ...
  // Devrait retourner CurrentWeather formaté avec une météo vide
